                ...
                <table class="table table-sm">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th @click="sortBtc('priceChangePercent')">
                                24時間の変動率(%)
                            </th>
                ...
                <table class="table table-sm">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th @click="sortUsdt('priceChangePercent')">
                                24時間の変動率(%)
                            </th>
    ...
    computed: {
        filterSortBtc: function() {
            ...
            if (this.sortBtcKey) {
                ...
                if (data) {
                    data.sort((a, b) => {
                        if (a[this.sortBtcKey] < b[this.sortBtcKey])
                            return -1 * set;
                        if (a[this.sortBtcKey] > b[this.sortBtcKey])
                            return 1 * set;
                        return 0;
        ...
        filterSortUsdt: function() {
            ...
            if (this.sortUsdtKey) {
                ...
                if (data) {
                    data.sort((a, b) => {
                        if (a[this.sortUsdtKey] < b[this.sortUsdtKey])
                            return -1 * set;
                        if (a[this.sortUsdtKey] > b[this.sortUsdtKey])
                            return 1 * set;
                        return 0;
