            ...
            <div class="row">
                <div class="col">
                    <div class="alert alert-info">
                        <h5>
                            <strong
                                >経費：{{ tax.expenses | addComma }}円</strong
                            >
                        </h5>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="alert alert-info">
                        <p>
                            （課税所得金額×0.02）÷
                            課税所得金額に対しての係数】＋2,000円
                        </p>
                        <h5>
                            <strong
                                >寄付金限度額：{{
                                    donationCalculation | addComma
                                }}円</strong
                            >
                        </h5>
                    </div>
                    ...
                    <div class="alert alert-warning">
                        ...
                        <div class="form-group row align-items-center">
                            <label for="insuranceFeeIncome" class="col-3"
                                >所得割率<span class="badge badge-danger"
                                    >必須</span
                                >
                                <span
                                    class="badge badge-primary"
                            ...
                            <label for="insuranceFeeEqual" class="col-3"
                                >均等割額<span class="badge badge-danger"
                                    >必須</span
                                >
                                <span
                                    class="badge badge-primary"
                        ...
                        <h5>
                            <strong
                                >保険料：{{
                                    insuranceFeeCalculation | addComma
                                }}円</strong
                            >
                        </h5>
                    </div>
                ...
                <div class="col">
                    <div class="alert alert-warning">
                        ...
                        <h5>
                            <strong
                                >住民税：{{
                                    municipalTaxCalculation | addComma
                                }}円</strong
                            >
                        </h5>
                    </div>
                    ...
                    <div class="alert alert-warning">
                        ...
                        <div class="form-group row">
                            <label for="pension" class="col-2"
                                >月々の年金額<span class="badge badge-danger"
                                    >必須</span
                                ></label
                            >
                            <validation-provider
    ...
    computed: {
        ...
        totalIncomeAmountCalculation: function() {
            if (this.tax.income > 0) {
                if (
                    this.tax.income <
                    this.tax.expenses + this.declarationLavel
                ) {
                    return 0;
                }
                return (
        ...
        taxableIncomeAmountCalculation: function() {
            if (this.totalIncomeAmountCalculation > 0) {
                if (
                    this.totalIncomeAmountCalculation <
                    this.deductionMoneyCalculation
                ) {
                    return 0;
                }
                return (
        ...
        donationCalculation: function() {
            ...
            if (this.taxableIncomeAmountCalculation > 0) {
                if (this.taxableIncomeAmountCalculation <= 1950000) {
                    donation =
                        (this.taxableIncomeAmountCalculation * 0.02) / 0.84895 +
                        2000;
                } else if (this.taxableIncomeAmountCalculation <= 3300000) {
                    donation =
                        (this.taxableIncomeAmountCalculation * 0.02) / 0.7979 +
                        2000;
                } else if (this.taxableIncomeAmountCalculation <= 6950000) {
                    donation =
                        (this.taxableIncomeAmountCalculation * 0.02) / 0.6958 +
                        2000;
                } else if (this.taxableIncomeAmountCalculation <= 9000000) {
                    donation =
                        (this.taxableIncomeAmountCalculation * 0.02) / 0.66517 +
                        2000;
                } else if (this.taxableIncomeAmountCalculation <= 18000000) {
                    donation =
                        (this.taxableIncomeAmountCalculation * 0.02) / 0.5937 +
                        2000;
                } else if (this.taxableIncomeAmountCalculation <= 40000000) {
                    donation =
                        (this.taxableIncomeAmountCalculation * 0.02) / 0.4916 +
                        2000;
                } else if (this.taxableIncomeAmountCalculation > 40000000) {
                    donation =
                        (this.taxableIncomeAmountCalculation * 0.02) / 0.44055 +
                        2000;
                }
        ...
        insuranceFeeCalculation: function() {
            if (
                ...
                this.totalIncomeAmountCalculation >
                    this.tax.insuranceFeeDeduction
            ) {
                return (
                    (this.totalIncomeAmountCalculation -
                        this.tax.insuranceFeeDeduction) *
                    ...
                    .catch(error => {
                        ...
                        if (error.response.status == 422) {
                            ...
                            for (var key in error.response.data.errors) {
                                errors[key] = error.response.data.errors[
                                    key
                                ].join();
                            }
